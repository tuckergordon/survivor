...
@Component({
  selector: 'app-round-nineteen',
  templateUrl: './round-nineteen.component.html',
  styleUrls: ['./round-nineteen.component.scss']
})
export class RoundNineteenComponent implements OnInit {
