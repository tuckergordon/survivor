...
@Component({
  selector: 'app-round-twelve',
  templateUrl: './round-twelve.component.html',
  styleUrls: ['./round-twelve.component.scss']
})
export class RoundTwelveComponent implements OnInit {
