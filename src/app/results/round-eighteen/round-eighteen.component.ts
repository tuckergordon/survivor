...
@Component({
  selector: 'app-round-eighteen',
  templateUrl: './round-eighteen.component.html',
  styleUrls: ['./round-eighteen.component.scss']
})
export class RoundEighteenComponent implements OnInit {
