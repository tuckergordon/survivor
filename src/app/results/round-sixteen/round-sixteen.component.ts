...
@Component({
  selector: 'app-round-sixteen',
  templateUrl: './round-sixteen.component.html',
  styleUrls: ['./round-sixteen.component.scss']
})
export class RoundSixteenComponent implements OnInit {
